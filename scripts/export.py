...
---------
    ...
    python -m scripts.export --localizer-ckpt checkpoints/localizer/L3/stage_complete.pt
    python -m scripts.export --siamese-ckpt   checkpoints/siamese/S2/stage_complete.pt

    # Custom output directory:
    python -m scripts.export --localizer-ckpt ... --siamese-ckpt ... --out-dir exports/
...
from model_localizer.model import MultiShotLocalizer, _normalize_owlv2  # noqa: F401
