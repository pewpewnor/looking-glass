...
from scripts.inference_localizer import _build_model_from_ckpt as _build_localizer
from scripts.inference_siamese import _build_model_from_ckpt as _build_siamese
...
def _sweep_threshold_inner(
    *,
    ...
    from model_siamese.dataset import build_val_loader as build_sia_loader
    from model_localizer.dataset import build_val_loader as build_loc_loader
    ...
    from model_localizer.evaluate import _iou_xyxy
